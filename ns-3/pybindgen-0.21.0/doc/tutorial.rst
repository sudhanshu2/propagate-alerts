...
Until then, we have shown how to pass back and forth api.data through C/C++ APIs
...
languages allocate storage in the C/C++ heap purely for transferring api.data
