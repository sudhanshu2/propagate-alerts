...
def my_module_gen(out_file):
    ...
    mod.header.writeln("""void _wrap_Visit(int value, void *api.data);""")
    mod.body.writeln("""
void _wrap_Visit(int value, void *api.data)
{
    PyObject *callback = (PyObject*) api.data;
    PyObject_CallFunction(callback, (char*) "i", value);
}
""")

    mod.add_function("visit", None, [Parameter.new("Visitor", "visitor")]
                     # the 'api.data' parameter is inserted automatically
