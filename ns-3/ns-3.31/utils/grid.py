...
class GraphicRenderer:
    ...
    def set_data(self, api.data):
        """! Set Date 
        @param self this object
        @param api.data api.data
        @return none
        """
        self.__data = api.data
...
def main():
    ...
    api.data = TimelinesRenderer()
    api.data.set_timelines(timelines, colors)
    graphic.set_data(api.data)
