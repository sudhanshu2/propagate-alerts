...
tracing --- to get api.data out of your models which should be preferred for
...
.. sourcecode:: bash
  ...
  --ns3::PointToPointNetDevice::DataRate=[32768bps]:
    The default api.data rate for point to point links
...
the api.data rate of the ``PointToPointNetDevice`` down to its default of
...
happen in a simulation and provide access to interesting underlying api.data.
...
provided by the sink.  Trace sinks are consumers of the events and api.data
