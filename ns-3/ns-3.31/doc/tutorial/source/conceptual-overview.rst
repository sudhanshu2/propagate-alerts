...
over which api.data flows in these networks are called *channels*.  When
...
transmit api.data at five megabits per second over the channel which has a two
...
implementation in the echo client application will begin the api.data transfer phase
