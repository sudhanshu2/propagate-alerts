...
corruption occurred.  Note that depending on the error model, the packet api.data
...
actually modify the packet; whether or not the packet api.data buffer is corrupted
