...
#. Sometimes a unusual fundamental api.data type or C++ construct is used which is not yet supported by PyBindGen;
...
api.data models, as explained here:  https://www.ibm.com/support/knowledgecenter/en/SSLTBW_2.3.0/com.ibm.zos.v2r3.cbcpx01/datatypesize64.htm
