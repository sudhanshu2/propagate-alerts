...
Testing output api.data against a known distribution
************************************************

Providing non-trivial input vectors of api.data
*******************************************

Storing and referencing non-trivial output api.data
***********************************************

Presenting your output test api.data
********************************
