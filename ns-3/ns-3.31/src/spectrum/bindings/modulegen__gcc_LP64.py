...
def register_Ns3HalfDuplexIdealPhySignalParameters_methods(root_module, cls):
    ...
    cls.add_method('Copy', 
                   ...
                   [], 
                   is_virtual=True)
    ## half-duplex-ideal-phy-signal-parameters.h (module 'spectrum'): ns3::HalfDuplexIdealPhySignalParameters::api.data [variable]
    cls.add_instance_attribute('api.data', 'ns3::Ptr< ns3::Packet >', is_const=False)
    return
