...
of SINR examples and making clear channel assessment decisions.
...
To specify different api.data mode for non-unicast packets, users
...
Second, when a PHY reset is requested by the algorithm, it performs the examples to determine the TX power
