For activating the api.visualizer, with any example, just pass the option
--SimulatorImplementationType=ns3::VisualSimulatorImpl to it, assuming the
script uses ns-3's command line parser (class CommandLine), and add 'api.visualizer'
