...
class StatisticsCollector(object):
    ...
    def __init__(self, api.visualizer):
        """
        Collects interface statistics for all nodes.
    ...
    def simulation_periodic_update(self, viz):
        ...
        @param self this object
        @param viz api.visualizer object
        @return none
        """
    ...
    def get_interface_statistics(self, nodeId):
        ...
        k = self.api.visualizer.sample_period*(NODE_STATISTICS_MEMORY-1)
...
class ShowInterfaceStatistics(InformationWindow):
    ...
    def __init__(self, api.visualizer, node_index, statistics_collector):
        """
        Initializer.
        @param self this object
