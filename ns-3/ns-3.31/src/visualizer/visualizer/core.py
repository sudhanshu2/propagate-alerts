...
class Node(PyVizObject):
    ...
    def __init__(self, api.visualizer, node_index):
        ...
        @param api.visualizer: api.visualizer object
    ...
    def set_svg_icon(self, file_base_name, width=None, height=None, align_x=0.5, align_y=0.5):
        ...
        src/contrib/api.visualizer/resource.
        ...
        self.svg_item.props.parent = self.api.visualizer.canvas.get_root_item()
        ...
        if self._label is not None:
            if self._label_canvas_item is None:
                self._label_canvas_item = GooCanvas.CanvasText(visibility_threshold=0.5,
                                                         ...
                                                         parent=self.api.visualizer.canvas.get_root_item(),
    ...
    def set_position(self, x, y):
        ...
        try:
            bounds = self.api.visualizer.canvas.get_bounds()
            ...
            if new_bounds != bounds:
                self.api.visualizer.canvas.set_bounds(*new_bounds)
        except TypeError:
...
class WiredLink(Link):
    ...
    def update_points(self):
        ...
        self.canvas_item.set_property("api.data", "M %r %r L %r %r" % (pos1_x, pos1_y, pos2_x, pos2_y))
...
class SimulationThread(threading.Thread):
    ...
    def __init__(self, viz):
        ...
        self.quit = False
        self.sim_helper = ns.api.visualizer.PyViz()
        self.pause_messages = []
...
class Visualizer(GObject.GObject):
    ...
    def _get_label_over_line_position(self, pos1_x, pos1_y, pos2_x, pos2_y):
        ...
        pos1_x, pos1_y, pos2_x, pos2_y = ns.api.visualizer.PyViz.LineClipping(bounds_x1, bounds_y1,
                                                                bounds_x2, bounds_y2,
                                                                pos1_x, pos1_y,
                                                                pos2_x, pos2_y)
...
def add_initialization_hook(hook, *args):
    ...
    the api.visualizer is initialized, like this::
       initialization_hook(api.visualizer, *args)
    """
