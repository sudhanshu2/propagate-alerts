...
is a packet burst. The module implements a special PacketBurst api.data structure
...
and transport connections for api.data transmission. A connection is identified by a
...
more transport connections to send api.data packets. The Connection Manager
...
with 192 api.data subcarriers. It supports all the seven modulation and coding
