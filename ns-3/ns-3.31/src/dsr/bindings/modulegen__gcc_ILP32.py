...
def register_Ns3Icmpv4DestinationUnreachable_methods(root_module, cls):
    ...
    cls.add_method('GetTypeId', 
                   ...
                   [], 
                   is_static=True)
    ## icmpv4.h (module 'internet'): void ns3::Icmpv4DestinationUnreachable::SetData(ns3::Ptr<const ns3::Packet> api.data) [member function]
    cls.add_method('SetData', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'api.data')])
...
def register_Ns3Icmpv4Echo_methods(root_module, cls):
    ...
    cls.add_method('Serialize', 
                   ...
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True, is_const=True)
    ## icmpv4.h (module 'internet'): void ns3::Icmpv4Echo::SetData(ns3::Ptr<const ns3::Packet> api.data) [member function]
    cls.add_method('SetData', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'api.data')])
...
def register_Ns3Icmpv4TimeExceeded_methods(root_module, cls):
    ...
    cls.add_method('Serialize', 
                   ...
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True, is_const=True)
    ## icmpv4.h (module 'internet'): void ns3::Icmpv4TimeExceeded::SetData(ns3::Ptr<const ns3::Packet> api.data) [member function]
    cls.add_method('SetData', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'api.data')])
