...
In addition, NetAnim also provides useful features such as tables to display meta-api.data of packets like the image below

.. figure:: figures/PacketStatistics.*
   :align: center
   :width: 500px

   An example of tables for packet meta-api.data with protocol filters
